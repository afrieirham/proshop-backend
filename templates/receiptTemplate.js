...
const receiptTemplate = (order) => {
    ...
    let msg = '<table class="body-wrap">    <tbody><tr>        <td></td>        <td class="container" width="600">            <div class="content">                <table class="main" width="100%" cellpadding="0" cellspacing="0">                    <tbody><tr>                        <td class="content-wrap aligncenter">                            <table width="100%" cellpadding="0" cellspacing="0">                                <tbody><tr>                                    <td class="content-block aligncenter">                                        <h2>Thanks for using our app</h2>                                    </td>                                </tr>                                <tr>                                    <td class="content-block">                                        <table class="invoice">                                            <tbody><tr>'
    msg += '<td>Order Reference: ' + order._id + '<br>' + order.createdAt + '</td></tr><tr><td><table class="invoice-items" cellpadding="0" cellspacing="0"><tbody>'
    for (const item of order.orderItems) {
        let it = '<tr><td>' + item.name + '</td><td class="alignright">RM ' + parseFloat(item.price).toFixed(2) + '</td></tr>'
        msg += it
    }
    msg += '<tr><td>Tax</td><td class="alignright">RM ' + parseFloat(order.taxPrice).toFixed(2) + '</td></tr>'
    msg += '<tr><td>Shipping</td><td class="alignright">RM ' + parseFloat(order.shippingPrice).toFixed(2) + '</td></tr>'
    msg += '<tr class="total"><td class="alignright" width="80%">Total</td><td class="alignright">RM ' + order.totalPrice +'</td></tr>'
    msg += '</tbody></table>'

    const close = '</td>                                </tr>                                <tr>                                    <td class="content-block aligncenter">                                        Proshop, University of Malaya                                    </td>                                </tr>                            </tbody></table>                        </td>                    </tr>                </tbody></table>                <div class="footer">                    <table width="100%">                        <tbody><tr>                            <td class="aligncenter content-block">Questions? Email <a href="mailto:">proshop@gmail.com</a></td>                        </tr>                    </tbody></table>                </div></div>        </td>        <td></td>    </tr></tbody></table></body></html>'
